...
export default class DeleteUserFromGroupContainer extends Component {
  constructor(props) {
    super(props)
    this.state = {}
  }
      ...
      return this.props.data.map((item) => {
        return (
          <tr
            key={item.userId}
            style={
              this.props.alreadyAddedUser.indexOf(item.userId) >= 0
                ? {
                    background: '#dddddd',
                    pointerEvents: 'none',
                  }
            ...
            <td>
              ...
              <input
                ...
                checked={
                  ...
                  this.props.alreadyAddedUser.indexOf(item.email) >= 0
                }
                style={{
                  fontSize: '18px',
                  padding: '0px',
